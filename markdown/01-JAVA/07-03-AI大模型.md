...
![PixPin_2025-07-07_12-09-10](..\img\PixPin_2025-07-07_12-09-10.DXOTSoFA.png)

```sh
# @workspace表示整个项目
@workspace 问题
@workspace 整个项目梳理一下，详细的介绍整个项目是做什么的？
@workspace 这个项目使用了那些技术栈
# 有什么不懂继续问，如
@workspace config包的内容是什么
# 进阶
登录的方法在哪里？流程是什么？
请把这个登录的流程，使用mermaid语法绘制出业务流程图
```
